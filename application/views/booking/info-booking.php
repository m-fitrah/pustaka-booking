...
/' . $i['image']); ?>" class="rounded" alt="No Picture" width="10%">
 ...
 <tr>
 <td>
 <a class="btn btn-sm btn-outlinedanger" onclick="information('Waktu Pengambilan Buku 1x24 jam dari Booking!!!')"
href="<?php echo base_url() . 'booking/exportToPdf/' . $this->session->userdata('id_user'); ?>"><span class="far fa-lg fa-fw fa-filepdf"></span> Pdf</a>
 </td>
 </tr>
 </table>
 </center>
